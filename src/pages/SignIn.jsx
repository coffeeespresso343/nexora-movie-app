    ...
    <div className="flex min-h-screen items-center justify-center px-6 bg-black text-white">
      <div className="w-full max-w-md rounded-2xl border border-white/10 bg-white/8 p-8">
        ...
        <button
          ...
          className="mt-6 flex w-full items-center justify-center gap-2 rounded-full border border-white/15 px-4 py-2.5 font-medium transition hover:bg-white/10 cursor-pointer"
        >
